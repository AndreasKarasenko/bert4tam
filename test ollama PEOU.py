...
base_message = """The construct “perceived ease of use” reflects the following four items when evaluating an app on 5-point Likert scales:
1. I found the app to be very easy to use.
2. The app was intuitive to use.
3. It was easy to learn how to use the app.
4. Handling the functions of the app was easy.
...
For the following comment: How would the author evaluate the construct “perceived ease of use”?
...
data.to_csv("./data/Ikea1_PEOU_gemma2_v2.csv", index=False)
